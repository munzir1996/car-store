...
import { CreateAdDialogComponent } from './create-ad/create-ad-dialog.component';
import { EditAdDialogComponent } from './edit-ad/edit-ad-dialog.component';
...
export class AdsComponent extends PagedListingComponentBase<CarVendorDto> {
